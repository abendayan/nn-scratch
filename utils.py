...
def text_to_unigrams(text):
    return [unigram for unigram in text]

# replace to text_to_unigrams for getting letter unigrams
...
def list_to_string(list_to_write):
    string = ""
    for to_write in list_to_write:
        string += to_write + '\n'
    return string[:-1]
